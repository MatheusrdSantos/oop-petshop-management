...
Animal::Animal(std::string classe, std::string nome_cientifico, char sexo, double tamanho, std::string dieta, Veterinario* veterinario, Tratador* tratador, std::string nome_batismo){
    m_classe = classe;
    m_nome_cientifico = nome_cientifico;
    m_sexo = sexo;
    m_tamanho = tamanho;
